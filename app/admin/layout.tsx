  ...
  return (
    <div className="flex h-dvh overflow-hidden bg-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top bar */}
        <header className="grid min-h-16 shrink-0 grid-cols-[1fr_auto] items-center gap-3 border-b border-[#E6EAF0] bg-white/90 px-4 py-2 backdrop-blur md:h-16 md:grid-cols-[minmax(220px,1fr)_minmax(280px,520px)_minmax(220px,1fr)] md:px-6 md:py-0">
